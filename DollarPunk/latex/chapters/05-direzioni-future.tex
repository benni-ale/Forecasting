...
Il primo passo è già operativo: un collector RSS (\texttt{italian\_news\_collector.py}) ingerisce quotidianamente gli articoli di sei testate italiane (ANSA, Il Sole 24 Ore, Investing.com Italia e altre) con inserimento idempotente e \emph{senza} scoring---gli articoli non alimentano i KPI, ma si accumulano nel cold store costruendo il corpus per la futura fase di annotazione.
